package id.sch.smktelkom_mlg.project.xiirpl108182838.notets.helper;
...
public class DBAdapter {
    ...
    public Cursor getData() {
        return db.query(TABEL_CATATAN, kolomCatatan, null, null, null,
                null, IDCATATAN + " DESC");
    }
    ...
    public boolean updateData(Catatan catatan, int id) {
        ...
        return db.update(TABEL_CATATAN, cv, IDCATATAN + "=" + id,
                null) > 0;
    }
