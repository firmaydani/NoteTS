...
public class TambahCatatanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isEdit) {
            //jika edit maka ambil data yang akan diedit
            //dan ditampilkan
    ...
    private void setupView() {
        ...
        ArrayAdapter adapter = new ArrayAdapter(getBaseContext(), android.R.layout.simple_spinner_item, warna);
    ...
    protected void simpan() {
        ...
        if (txtJudul.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(getBaseContext(), "Judul Harus Diisi", Toast.LENGTH_LONG).show();
